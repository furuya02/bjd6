...
public final class ServerV6Test implements ILife {
	...
	public static void beforeClass() throws Exception {
		...
		OneBind oneBind = new OneBind(new Ip(IpKind.V6_LOCALHOST), ProtocolKind.Tcp);
	...
	public void setUp() {
		//クライアント起動
		cl = Inet.connect(new Ip(IpKind.V6_LOCALHOST), 21, 10, null, this);
